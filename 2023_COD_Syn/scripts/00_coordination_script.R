...
#using synthetic data for privacy reasons
library(tidyverse)
library(readxl)
library(patchwork)
library(viridis)

date_code<-"20230809SYN"
...
input_date_code<-"20230621"
#all_life_table_data_fixed<-read_tsv(sprintf("generated_data/%s_ms_all_life_table_data.tsv",input_date_code))

#synthetic data here
all_life_table_data_fixed<-read_tsv(sprintf("../2023_Synthetic_COD_Data/generated_data/%s_syn_cod_table.tsv",input_date_code))
